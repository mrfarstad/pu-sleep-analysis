...
public class UserController implements Initializable {
  ...
  public void deleteSleepDataFromDate(LocalDate ld) {
    List<SleepData> sleepDataList = SleepAnalysis.userDataFetch.getSleepDataByViewer();
    SleepData sleepData =
  ...
  public void deleteStepsDataFromDate(LocalDate ld) {
    List<StepsData> stepsDataList = SleepAnalysis.userDataFetch.getStepsDataByViewer();
    StepsData stepsData =
  ...
  public void deletePulseDataFromDate(LocalDate ld) {
    List<PulseData> pulseDataList = SleepAnalysis.userDataFetch.getPulseDataByViewer();
    PulseData pulseData =
  ...
  public void handleRemoveDoctorButton() {
    ...
    if (selected != null) {
      SleepAnalysis.userDataFetch.answerDataAccessRequest(selected, "REJECTED");
  ...
  public void handleAcceptDoctorButton() {
    ...
    if (selected != null) {
      SleepAnalysis.userDataFetch.answerDataAccessRequest(selected, "ACCEPTED");
